window.onload = function() {
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 1 **********************************************************
    //create object
    let obj = {
        a: 2,
        b: 4
    ...
    ***********************************************************************************************/
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 2 **********************************************************
    ...
    ***********************************************************************************************/
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 3 **********************************************************
     //create object
    let objApply = {
        a: 2,
        b: 4
    ...
    ***********************************************************************************************/
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 4 ********************************************************** 
    ...
    ************************************************************************************************/
     ...
     */
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 5 ********************************************************** 
    ...
    ************************************************************************************************/
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 6 ********************************************************** 
    //Simple Example bind() function
    console.log("Simple Example bind() function");
    ...
    ************************************************************************************************/
    ...
    console.log("Bind object to specific context");
    ...
    ************************************************************************************************/
    ...
    /* UNCOMMENT TO RUN THE CODE EXAMPLE 7 ********************************************************** 
    //Example with controls and events
    console.log("Example with controls and events");
    ...
    // "this" inside of the talk function could be different depending on what context is calling it. When we want to replace this context we have to use bind() method 
    // and setup "this" that we need in this very moment.
    ************************************************************************************************/
}